...
const ShopModalProducts = ({ item }) => {
	...
	return (
		<div className="modal-shop">
			<img onClick={handleShow} src={item.imgCollection[0]} draggable="false" className='img-product img-fluid' alt='imgProduct' />
...
export default ShopModalProducts